...
function shareShortcode($atts, $content = null) {
	...
	<div class="social-icons share-row">
		<?php echo $title; ?>
		<?php if($flatsome_opt['social_icons']['whatsapp']) { ?><a href="whatsapp://send?text=<?php echo $post_title; ?>%20-%20<?php echo $permalink; ?>" data-action="share/whatsapp/share" class="icon icon_whatsapp tip-<?php echo $tooltip ?>" rel="nofollow" title="<?php _e('Share on WhatsApp','flatsome'); ?>"><span class="icon-phone" /></a><?php } ?>
